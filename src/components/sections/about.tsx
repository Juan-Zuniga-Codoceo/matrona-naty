...
const WavePattern = () => (
 <div className="absolute top-0 left-0 w-full overflow-hidden">
   <svg className="w-full" height="50" viewBox="0 0 1200 120" preserveAspectRatio="none">
...
export default function About() {
 ...
 return (
   <section id="about" className="relative mt-[-50px] pt-20 pb-20 bg-white">
     {/* Separador superior */}
     <WavePattern />
     ...
     <div className="max-w-6xl mx-auto px-4">
       ...
       <div className="text-center mb-16">
         <h2 className="text-4xl font-bold mb-4 relative z-20">
           Sobre <span className="text-[#E84E89]">Matrona Naty</span>
         </h2>
         <div className="w-20 h-1 bg-[#E84E89] mx-auto relative z-20"></div>
       </div>
       ...
       <div className="flex flex-col md:flex-row items-center gap-12">
         ...
         <div className="md:w-1/2">
           <div className="relative w-full aspect-square max-w-md mx-auto">
             <div className="absolute inset-0 bg-pink-100 rounded-2xl rotate-6"></div>
             <div className="absolute inset-0 bg-pink-200 rounded-2xl -rotate-6"></div>
             <div className="relative h-full w-full">
               <Image
                 ...
                 className="rounded-2xl shadow-lg object-contain relative"
               />
             </div>
           </div>
         </div>
         ...
         <div className="md:w-1/2 space-y-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
             {values.map((value, index) => (
               <Card 
                 key={index} 
                 className="hover:shadow-lg transition-all duration-300 border-2 border-pink-100 bg-gradient-to-br from-white to-pink-50 transform hover:-translate-y-1"
               >
     ...
     {/* Separador inferior */}
     <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-b from-white to-pink-50"></div>
   </section>
 );
}